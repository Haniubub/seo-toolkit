...
<p align="center">
  <img src="docs/assets/fanout.zh.svg" alt="seo-audit 门控式多智能体扇出" width="1200">
</p>
...
> 💡 **使用 DeepSeek V4-Flash 差距还能更大。** 上表用的是保守的 DeepSeek V3.2 档位。把同一审计换成 **V4-Flash**（输入 `$0.14/M`、输出 `$0.28/M`）会把 DeepSeek 侧降到 **≈ $0.02**，从而把对比提升到 **~21×（对比 Sonnet 5）** 和 **~54×（对比 Opus 5）**。所以诚实范围是 **~12×–54×**，换用更新的 DeepSeek 模型只会让数字更好。
